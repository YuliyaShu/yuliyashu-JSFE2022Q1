...
class Footer {
  ...
  static drawFooter(bodyWrapper: AnyElement): void {
    ...
    Utils.createAnyElement(footer.element, { type: 'a', className: ['footer__links'], innerText: 'YuliyaShu july 2022', attributes: [['href', 'https://github.com/YuliyaShu']] })
    const schoolLink = Utils.createAnyElement(footer.element, { type: 'a', className: ['footer__links'], attributes: [['href', 'https://rs.school/']] });
