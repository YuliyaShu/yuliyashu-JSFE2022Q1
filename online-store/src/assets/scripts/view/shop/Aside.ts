...
class Aside {
  ...
  static drawAside(bodyWrapper: AnyElement): void {
    ...
    if (quantity instanceof HTMLElement) {
      ...
      Utils.createAnyElement(quantity, { type: 'div', className: ['aside__filter-slider'], attributes: [['id', 'slider-q']] });
    ...
    if (year instanceof HTMLElement) {
      ...
      Utils.createAnyElement(year, { type: 'div', className: ['aside__filter-slider'], attributes: [['id', 'slider-y']] });
    ...
    if (designer instanceof HTMLElement) {
      Utils.createAnyElement(designer, { type: 'button', className: ['button', 'designer__1'], innerText: 'Peppy' });
      Utils.createAnyElement(designer, { type: 'button', className: ['button', 'designer__2'], innerText: 'Eleven' });
      Utils.createAnyElement(designer, { type: 'button', className: ['button', 'designer__3'], innerText: 'Infinite_Jest' });
    }

    // 'color'
    const color = document.querySelector('.color');
    if (color instanceof HTMLElement) {
      Utils.createAnyElement(color, { type: 'button', className: ['button', 'color__1'], innerText: 'Green' });
      Utils.createAnyElement(color, { type: 'button', className: ['button', 'color__2'], innerText: 'Orange' });
      Utils.createAnyElement(color, { type: 'button', className: ['button', 'color__3'], innerText: 'White' });
    }

    // 'size'
    const size = document.querySelector('.size');
    if (size instanceof HTMLElement) {
      Utils.createAnyElement(size, { type: 'button', className: ['button', 'size__1'], innerText: '20x20' });
      Utils.createAnyElement(size, { type: 'button', className: ['button', 'size__2'], innerText: '50x50' });
      Utils.createAnyElement(size, { type: 'button', className: ['button', 'size__3'], innerText: '70x70' });
    }
    // 'popularity'
    const popularity = document.querySelector('.popularity');
    if (popularity instanceof HTMLElement) {
      Utils.createAnyElement(popularity, { type: 'button', className: ['button', 'popularity__1'], innerText: '' });
    }
